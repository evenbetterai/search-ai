...
class TestSelections(object):
    ...
    class TestSelection(TestCaseWithPopulation):
        ...
        def setUp(self):
            ...
            self.one_individual = self.create_population(
                1,
                None,
                None,
                [1]
            )
            self.two_individuals = self.create_population(
                2,
                None,
                None,
                [1,
            ...
            self.five_individuals = self.create_population(
                5,
                None,
                None,
                [1,
        ...
        def check_selection_attributes(self):
            self.assertEqual(
                self.selection.number_of_parents,
                self.number_of_parents
            )
            self.assertEqual(
                Selection.MIN_NUMBER_OF_PARENTS,
                self.min_number_of_parents
            )
