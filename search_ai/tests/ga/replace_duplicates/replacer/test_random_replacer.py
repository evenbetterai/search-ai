...
class TestRandomReplacer(TestReplacers.TestReplacer):
    ...
    def test_replace_in_population(self):
        ...
        self.check_replace_methods(0, self.replace_duplicates._population)

        self.reset_mocks()
        self.replacer.replace_in_population(self.replace_duplicates, 1)
        self.check_replace_methods(1, self.replace_duplicates._population)
    ...
    def check_replace_methods(self, index, ind_container):
        ...
        ind_container.__setitem__.assert_called_once_with(index, self.child)
