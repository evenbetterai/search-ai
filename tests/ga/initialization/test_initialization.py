...
class TestInitialization(unittest.TestCase):
	def setUp(self):
		...
		self.init1 = new Initialization(new BinaryFitnessExample(), 10, 50, (InitLeafExample1, InitLeafExample2))
		self.init2 = new Initialization(new ContinuousFitnessExample(), 10, 50, [])
